      ...
      >
        <h3 style={style.headerMargin}>
          ...
          <a
            ...
            target="_blank"
            href="https://github.com/shanjijian/markdown2html"
            style={style.noBorder}
          >
            <img alt="" style={style.img} src="https://badgen.net/github/stars/shanjijian/markdown2html" />
          </a>
        </h3>

        <p style={style.lineHeight}>支持自定义样式的 Markdown 编辑器；</p>
        <p style={style.lineHeight}>支持微信公众号、知乎和稀土掘金。</p>
        <h3 style={style.headerMargin}>GitHub</h3>
